...
from CNFE.lin import Cipher, ParameterBuilder, PredefinedParameters
...
pr.dump_stats(f"{FNAME}.lin.stat")

print("True Result :", true_result)
print("Query Result:", res)
print("Noise       :", res - true_result)

pstats.Stats(pr).strip_dirs().sort_stats("tottime").print_stats(20)
