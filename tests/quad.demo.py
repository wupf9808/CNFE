...
from CNFE.quad import DataOwner, KeyCurator, PublicParameter, User
from CNFE.utils import RNG


def test(param: PublicParameter, sigma: int, x: np.array, a: np.array):
    # KeyCurator: setup
    ...
    res = user.query(a, ct, sk)

    return res


if __name__ == "__main__":
    from CNFE.quad import ParameterBuilder, PredefinedParameters
